...
.. grid:: 2
    ...
    .. grid-item-card:: :octicon:`package` World Generation API

        A voxel world generation API with emphasis on end user configuration and extensibility.

    .. grid-item-card:: :octicon:`versions` Platform Implementations
...
.. grid:: 2
    ...
    .. grid-item-card:: :octicon:`plug` Addon System

        An addon loader, which allows addons to interface with the Terra API in a platform-agnostic setting.
        Addons provide the majority of Terra's world generation *functionality*.

    .. grid-item-card:: :octicon:`file-code` Core Addons
